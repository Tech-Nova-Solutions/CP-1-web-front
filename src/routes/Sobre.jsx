  ...
  return (
    ...
    <div className='container_sobre'>
      ...
      <div className='sobre'>
        ...
        <p className='text-4'>Na TN Sports, acreditamos que o esporte é uma forma de vida que deve ser acessível a todos. Por isso, estamos sempre em busca de novas maneiras de tornar nossos produtos e serviços mais acessíveis e inclusivos. Nossa loja oferece uma experiência de compra agradável e eficiente, tanto online quanto presencial, com opções de entrega rápida e segura. </p>
        <p className='text-5'>Explore nossa loja e descubra uma nova forma de alcançar suas metas esportivas. Agradecemos por escolher a TN Sports e por nos permitir fazer parte da sua jornada esportiva. Estamos ansiosos para ajudá-lo a atingir seus objetivos e a viver sua paixão pelo esporte. </p>
      </div>
    </div>
